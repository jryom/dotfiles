...
curl -s -u $USER:$TOKEN  https://api.github.com/notifications \
   ...
   | xargs -n 4 sh -c \
   'terminal-notifier -group "Github" -title "GitHub Notification" -subtitle "$0 $1" -message "$2" -open "https://github.com/notifications" -appIcon "https://github.com/fluidicon.png" -contentImage "$3"'
